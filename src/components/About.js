    ...
    <div className="flex flex-row  gap-24 mt-32 mb-16 h-auto mx-12 flex-wrap lg:flex-nowrap ">
      ...
      <div className="flex flex-col gap-y-7">
        ...
        <p className="text-xl leading-8">
          I am from Uttarakhand 📌, currenlty persuing BCA(Bachelor of Computer
          Application) 🎓 from Dev Bhoomi Uttarakhand University (DBUU) Dehradun
          🏛.
          <br />
          ...
          committed to continuous learning and growth, and I thrive in dynamic,
